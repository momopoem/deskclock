...
人感入力を0.6秒連続して確認すると画面を点灯し、最後の確認から最低5分保持します。
人感・タッチが30秒途絶えたら、表示中に約60秒間隔で既存カメラの顔検出を非同期実行します。
登録人物かどうかに関係なく顔を検出すると、最後の顔検出から10分間保持します。
猶予が過ぎ、顔の未検出が連続3回以上になってから従来の減光・消灯判定へ戻ります。
明るい場所では従来どおり減光のみになる場合があります。

カメラエラーは未検出として数えず、確認不足の猶予を最大2分追加します。
エラーだけで永久に点灯し続けることはありません。暗さ・横顔・カメラの死角などで顔を
検出できない場合、在席中でも猶予後に消灯する可能性があります。
